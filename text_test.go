...
func (s TEXTTestsSuite) Test_text2(c *C) {
	...
	check := cSL(`<text style="font-family:Verdana;font-size:55;fill:blue" x="250" y="150">Hello, out there</text>`)
...
func (s TEXTTestsSuite) Test_text_AddString(c *C) {
	...
	check := cSL(`<text style="font-family:Verdana;font-size:55;fill:blue" x="250" y="150">Hello, out there Next hello, out there</text>`)
	f := style.Font("font-family:Verdana;font-size:55")
	text := Text(style.Style().Fill("blue").Font(f))
	text = text.XY(250, 150).String("Hello, out there")
...
func (s TEXTTestsSuite) Test_Transform(c *C) {
	...
	check := cSL(`<text style="font-family:Verdana;font-size:55;fill:blue" transform="matrix(12.00, 34.00, 45.00, 34.50, 212.00, 4.45)" x="250" y="150">Hello, out there</text>`)
	f := style.Font("font-family:Verdana;font-size:55")
	text := Text(style.Style().Fill("blue").Font(f))
	text = text.XY(250, 150).String("Hello, out there")
...
func (s TEXTTestsSuite) Test_text_Attrs(c *C) {
	...
	check := cSL(`<text id="id-1">Next hello, out there</text>`)
